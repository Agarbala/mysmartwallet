        ...
        <form id="nuovaTransazione" action="/transazioni/aggiungi" method="GET">
          ...
          <table class="modalInputs">
            ...
            <tr>
              ...
              <td><input type="text" id="nomeNuovo" name="nome" required /></td>
            </tr>
            <tr>
            ...
            <tr id="obiettivoSel">
              ...
              <td>
                <select id="obiettivo" name="obiettivoid">
