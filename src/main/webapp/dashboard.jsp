					...
					<div id="bilanciContainer">
						...
						<div id="bilanciMens2">
							...
							<div id="bilancioCol1" class="shadow-sm rounded">
								...
								<table id="obiettiviTable" class="table table-striped table-hover align-middle">
									<h5>Obiettivi <a data-bs-toggle="modal" data-bs-target="#aggiungiObiettivo"
											href=""><i class="bi bi-plus-circle-fill"></i></a></h5>
									...
									<tbody>
										<c:forEach items="${conto.obiettivi}" var="obiettivo">
											<tr>
												...
												<td>
													${obiettivo.datafine}
													<%-- <fmt:parseDate value="${obiettivo.datafine}"
														pattern="yyyy-MM-dd" var="dataFineObiettivo" type="date" /> --%>
													<%-- <fmt:formatDate pattern='${dataPattern}'
														value="${dataFineObiettivo}" /> --%>
												</td>
						...
						<div id="importiTabBox" class="shadow-sm rounded">
							...
							<table id="transazioniTable"
								...
								<h5>Transazioni recenti <a href="#" data-bs-toggle="modal"
										data-bs-target="#aggiungiTransazione"><i class="bi bi-plus-circle-fill"></i></a>
								</h5>
								<thead>
									<tr>
								...
								<tbody>
									<c:forEach items="${conto.transazioni}" var="transazione">
										<tr>
											...
											<td class="td_center">
												<a class="modButton" id="mod" title="Modifica" href="#"
													data-bs-toggle="modal" data-bs-target="#modificaTransazioneModale"
