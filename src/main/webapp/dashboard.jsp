          ...
          <div id="bilanciMens2">
                ...
                <tbody>
                  <c:forEach items="${conto.obiettivi}" var="obiettivo">
                    <tr>
                      ...
                      <td>
                        <fmt:formatNumber type="currency" currencySymbol="€"
                          >${obiettivo.importo}</fmt:formatNumber
                        >
                      </td>
                      <td>
                        <fmt:formatNumber type="currency" currencySymbol="€"
                          >${risparmiato.get(obiettivo.id)}</fmt:formatNumber
                        >
                      </td>
                      <td>
                        <fmt:formatNumber type="currency" currencySymbol="€">
            ...
            <div id="bilancioCol2" class="shadow-sm rounded">
              ...
              <div class="bilTotValuta">
                ...
                <h2
                  id="bilH2"
                  class="${bilancio < 0 ? 'negativo' : 'positivo'}"
                >
                  <fmt:formatNumber type="currency" currencySymbol="€">
            ...
            >
              <h5>
                ...
                <a
                  href="#"
                  data-bs-toggle="modal"
                  data-bs-target="#aggiungiTransazione"
                  ><i class="bi bi-plus-circle-fill"></i
                ></a>
              </h5>
              <thead>
